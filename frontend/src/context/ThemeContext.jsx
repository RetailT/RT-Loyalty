...
const darkTheme = {
  bg:'#0a0a0a', bgCard:'#111111', bgSubtle:'#161616', bgAccent:'#1a1a1a',
  navBg:'rgba(10,10,10,0.95)', navBorder:'#1f1f1f', navShadow:'0 1px 0 rgba(255,107,0,0.08)',
  modalBg:'rgba(0,0,0,0.7)', pointsBg:'rgba(255,107,0,0.06)', pointsBorder:'rgba(255,107,0,0.2)',
  text:'#f5f5f5', textSub:'#d0d0d0', textMuted:'#888888', textFaint:'#555555',
  border:'#222222',
  successText:'#34d399', successBg:'rgba(52,211,153,0.08)', successBorder:'rgba(52,211,153,0.25)',
  errorText:'#f87171', errorBg:'rgba(248,113,113,0.08)', errorBorder:'rgba(248,113,113,0.25)',
  redText:'#f87171', shadow:'0 4px 24px rgba(0,0,0,0.4)', shadowHover:'0 8px 40px rgba(255,107,0,0.15)',
};
