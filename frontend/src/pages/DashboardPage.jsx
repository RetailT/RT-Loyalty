// src/pages/DashboardPage.jsx — Real API
...
export default function DashboardPage({ onNavigate }) {
  ...
  return (
    <div style={{ maxWidth:900, margin:'0 auto', padding: isMobile?'24px 16px 100px':'32px 32px 60px' }}>
      ...
      {/* Points Hero */}
      <div style={{ background:tierCfg.gradient, borderRadius:20, padding: isMobile?20:28, marginBottom:20, position:'relative', overflow:'hidden', boxShadow:'0 16px 48px rgba(0,0,0,0.3)' }}>
